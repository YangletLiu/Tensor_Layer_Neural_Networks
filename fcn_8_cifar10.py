...
def fcn_8():
    ...
    class neuralNetwork(nn.Module):
        ...
        def __init__(self, in_dim, n_hidden_1, n_hidden_2, n_hidden_3, n_hidden_4,
                     n_hidden_5, n_hidden_6, n_hidden_7, out_dim):
    ...
    # define NN model
    model = neuralNetwork(3072, 4096, 4096, 2048, 2048, 1024, 1024, 512, 10)
...
train_loss,train_acc,test_loss,test_acc = fcn_8()

# write csv
with open('cifar10_fcn_8_testloss.csv','w',newline='',encoding='utf-8') as f:
    f_csv = csv.writer(f)
...
plt.sca(sub1)
plt.title('FCN-8 Loss on CIFAR10 ')
...
plt.sca(sub2)
plt.title('FCN-8 Accuracy on CIFAR10')
