...
def mnn_4():
    ...
    # define NN model
    model = neuralNetwork(3072, 3072, 3072, 3072,3072, 3072, 3072, 3072, 10)
...
test_loss,test_acc,train_loss,train_acc = mnn_4()

# write csv
with open('cifar_mnn8_testloss.csv','w',newline='',encoding='utf-8') as f:
    f_csv = csv.writer(f)
...
plt.sca(sub2)
plt.title('MNN Accuracy on CIFAR10')
