...
def tnn_4():
    ...
    class tNN(nn.Module):
        def __init__(self):
            ...
            self.W_4 = nn.Parameter(torch.randn((32, 10, 96), requires_grad=True, dtype=torch.float))
            self.B_4 = nn.Parameter(torch.randn((32, 10, 1), requires_grad=True, dtype=torch.float))
