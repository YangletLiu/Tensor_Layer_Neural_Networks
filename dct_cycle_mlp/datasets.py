...
def build_transform(is_train, args):
    ...
    if is_train:
        ...
        # print("training transform: ", transform)
        return transform
    ...
    # Remove the ToTensor and Normalize transform in evaluation transformer:
    t.append(transforms.ToTensor())
    t.append(transforms.Normalize(IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD))
    # print("evaluation transform: ", transforms.Compose(t))
