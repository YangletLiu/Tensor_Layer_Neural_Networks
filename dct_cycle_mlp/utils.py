...
class MetricLogger(object):
    ...
    # 'log_every' for data_prefetcher
    # def log_every(self, prefetcher, print_freq, header=None):
    #     i = 0
    #     if not header:
    #         header = ''
    ...
    #     space_fmt = ':' + str(len(str(len(prefetcher)))) + 'd'
    #     log_msg = [
    #         header,
    #         '[{0' + space_fmt + '}/{1}]',
    #         'eta: {eta}',
    ...
    #         if i % print_freq == 0 or i == len(prefetcher) - 1:
    #             eta_seconds = iter_time.global_avg * (len(prefetcher) - i)
    #             eta_string = str(datetime.timedelta(seconds=int(eta_seconds)))
    #             if torch.cuda.is_available():
    #                 print("\r"+log_msg.format(
    #                     i, len(prefetcher), eta=eta_string,
    #                     meters=str(self),
    #                     time=str(iter_time), data=str(data_time),
    #                     memory=torch.cuda.max_memory_allocated() / MB), end="")
    #             else:
    #                 print("\r"+log_msg.format(
    #                     i, len(prefetcher), eta=eta_string,
    #                     meters=str(self),
    #                     time=str(iter_time), data=str(data_time)), end="")
    #         i += 1
    #         obj = prefetcher.next()
    #         end = time.time()
    ...
    #         header, total_time_str, total_time / len(prefetcher)))


    # 'log_every' for normal dataloader
