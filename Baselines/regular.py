...
# }
__all__ = [
    'AlexNet','VGG', 'vgg11', 'vgg11_bn', 'vgg13', 'vgg13_bn', 'vgg16', 'vgg16_bn', 'vgg19_bn', 
    'vgg19','ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152'
]
models_dir = os.path.expanduser('~/.torch/models')
model_name = {'alexnet':'alexnet-owt-4df8aa71.pth',
...
def alexnet(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load(os.path.join(models_dir, model_name['alexnet'])))
    return model
