...
from regular import alexnet, vgg11, resnet18
...
parser.add_argument('--data', default='/xfs/imagenet/', help='path to dataset')
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        loss, a1, a5 = train(train_loader, model, criterion, optimizer, epoch, args.print_freq)
        ...
        test_a1.append(prec1)
        test_a5.append(prec5)
    ...
    with open("{}_info.pkl".format(args.arch),'wb') as file:
        pkl.dump([train_loss_list, train_a1, train_a5, test_a1, test_a5],file)
        print('saving ok')
...
def train(train_loader, model, criterion, optimizer, epoch, print_freq):
    ...
    return losses.val,top1.val, top5.val
