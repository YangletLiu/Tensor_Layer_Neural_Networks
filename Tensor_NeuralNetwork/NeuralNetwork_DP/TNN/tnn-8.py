...
class tNN(nn.Module):
    def __init__(self):
        ...
        self.W_3 = nn.Parameter(torch.randn((28, 60, 300), requires_grad=True, dtype=torch.float))
        self.B_3 = nn.Parameter(torch.randn((28, 60, 1), requires_grad=True, dtype=torch.float))
        self.W_4 = nn.Parameter(torch.randn((28, 10, 60), requires_grad=True, dtype=torch.float))
