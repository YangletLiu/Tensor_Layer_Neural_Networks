#   !/Tensor_CNN/Neuralnetwork_DP/dct-tnn_8.py
#   -*- coding:utf-8 -*-
#   author:    shijianhan
#   created at: 2020.6.26
#   profile:    8-layer tensor neuralnetwork implemented by DCT transform in DCT domain
...
def tnn_8():
    ...
    for epoch in range(epochs_num):
        ...
        train_acc_epoch.append(running_acc/i)
...
test_loss,test_acc,train_loss,train_acc = tnn_8()

# write csv
with open('fashion_tnn8_testloss.csv','w',newline='',encoding='utf-8') as f:
    f_csv = csv.writer(f)
...
plt.sca(sub1)
plt.title('Tensor NeuralNetwork in time domain Loss ')
...
plt.sca(sub2)
plt.title('Tensor NeuralNetwork in time domain Accuracy ')
